...
DASHBOARD_DIR  = "../dashboard/data"  # ← FIXED: was "./dashboard/data"
...
def update_dashboard_files():
    ...
    print(f"  ✅ Dashboard updated: {len(api_data)} API | {len(rss_data)} RSS")
    ...
    while True:
        try:
            for message in consumer:
                ...
                # Update dashboard setiap kali ada pesan baru
                update_dashboard_files()
        except Exception as e:
